...
DS_SPEED = 14.3 #cm/ns  clock cycle = 160000000 MHz -> 6,25*10^(-12) s-> 6,25*10^-3 
...
data.Add("run_100793/data_all_0000.root")
...
VetoQdc = ROOT.TH1D("VetoQdc", "VetoQdc", DSn_bins, DSx_min, DSx_max)
VetoQdcPerBar = ROOT.TH2D("VetoQdcPerBar", "VetoQdcPerBar", DSn_bins, DSx_min, DSx_max, DSn_bins, DSx_min, DSx_max) 
VetoQDCPerChannel = ROOT.TH2D("VetoQDCPerChannel", "VetoQDCPerChannel; veto channel; qdc ", DSn_bins, DSx_min, DSx_max, DSn_bins, DSx_min, DSx_max)
...
print(f'\nRelative eff of [15, 25] wrt [35, 45] is {relative_eff}')
print('\nDone')
